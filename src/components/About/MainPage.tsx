...
import AboutIntro1 from "../../../public/images/general/about/tech-journey-portrait.png";
    ...
    <>
      <section>
        <div className="flex justify-center mt-[8vh]">
          <div className="w-[75%] sm:w-[70%] lg:w-[65%] flex justify-center items-center flex-col">
            ...
            <div className="relative sm:w-[80%] lg:w-[60%] object-cover">
              <Image
                src={AboutMain}
      ...
      <section className="mt-[6vh] border-b-[1px] border-b-lightText20 dark:border-b-darkText20 md:border-none">
        ...
        <div className="flex justify-end mt-8">
          <div>
            <MainButton text="Download Resume" link="/api/resume" />
          </div>
        </div>
      </section>
